...
5. **可扩展**: 模块化设计，便于功能扩展 / Modular design for easy feature expansion
...
Through this project, we have validated the application potential of LLM in the field of system testing and provided new ideas for the development of automated testing tools. 